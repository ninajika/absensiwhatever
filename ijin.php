...
<body>
 ...
 <div class="border">
  ...
  <br><br>
  <form action="proses_ijin.php" method="POST" enctype="multipart/form-data">
   <textarea id="ijin_text" aria-label="text" name="ijin" rows="4" cols="20"></textarea>
   <br>
 ...
 <script>
  ...
  document.getElementById("submit-button").addEventListener("click", function(event) {
   ...
   var textareaValue = document.getElementById("ijin_text").value;
   if (textareaValue === "") {
